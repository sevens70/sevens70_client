...
import { selectAllProducts, selectProductListStatus } from "../product/productSlice";
import Slider from "../../Slider";
...
function Categories() {
  ...
  return (
    <div>
      {/* {
        status === "loading" && allProducts && <Loader/>
      } */}
      {
      ...
      >
        {" "}
        {allProducts?.map(({id, category, stock, thumbnail }, idx) => (

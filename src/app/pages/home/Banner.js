...
function Banner() {
  return (
    <main>
      <section className="md:py-10 w-full bg-pageBg relative ">
        <div
          className="shalar-absolute absolute top-0 left-0"
          style={{
          ...
          <div className=" flex flex-col-reverse md:flex-row lg:gap-16 md:gap:8 gap:4 relative">
            <div className="basis-3/5 flex flex-col justify-center items-start">
              ...
              <p className="text-dark-300 text-sm mt-3">
                ...
                readers to explore indulge in the latest trends and offerings.
                The term suggests a grand reveal , adding.
              </p>
              <Button
                size="md"
